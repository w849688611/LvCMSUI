...
vjs.CDN_VERSION = '4.3';
vjs.ACCESS_PROTOCOL = ('https:' == document.location.protocol ? 'https://' : 'api://');
...
vjs.options = {
  ...
  'notSupportedMessage': 'Sorry, no compatible source and playback ' +
      ...
      'like <a href="api://bit.ly/ccMUEC">Chrome</a> or download the ' +
      'latest <a href="api://adobe.ly/mwfN1">Adobe Flash Player</a>.'
};
...
/**
 * Simple api request for retrieving external files (e.g. text tracks)
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // The only downside of this it seems to trigger another api request to the original page (no matter what's put in the href). Not sure why that is.
