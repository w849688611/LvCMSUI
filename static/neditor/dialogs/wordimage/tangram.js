...
// 
//      api:// tangram.baidu.com/license.html
// 
...
baidu.swf.createHTML = function (options) {
    ...
    options['codebase'] = 'api://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0';
    ...
    options['pluginspage'] = 'api://www.macromedia.com/go/getflashplayer';
    str.push('<embed');
    var salign;
    for (k in options) {
        item = options[k];
